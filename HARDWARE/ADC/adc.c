...
{ 	
	...
	ADC_Init(ADC1, &ADC_InitStructure);	//根据ADC_InitStruct中指定的参数初始化外设ADCx的寄存器   
  	...
  	ADC_RegularChannelConfig(ADC1, ADC_Channel_3, 1, ADC_SampleTime_1Cycles5 );   		//ADC1,ADC通道,采样时间为1.5周期
...
//	GPIO_InitTypeDef GPIO_InitStructure;
	...
	ADC_Init(ADC1, &ADC_InitStructure);	//根据ADC_InitStruct中指定的参数初始化外设ADCx的寄存器   
  	...
  	ADC_RegularChannelConfig(ADC1, ADC_Channel_2, 1, ADC_SampleTime_1Cycles5 );   		//ADC1,ADC通道,采样时间为1.5周期
